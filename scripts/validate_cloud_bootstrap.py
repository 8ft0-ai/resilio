...
EXPECTED_BOOTSTRAP_TERRAFORM_BLOBS = {
    ...
    "phase4_authority.tf": "71b46a6428f43bff7b7575c4dab003e5baed322c",
...
def check_phase4_authority(errors: list[str]) -> None:
    ...
    exact_locals = (
        ...
        f'phase4_build_workflow_sha                = "{PHASE4_BUILD_WORKFLOW_SHA}"',
